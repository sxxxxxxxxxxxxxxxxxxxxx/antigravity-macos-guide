...
1. **账号未满 18 岁（年龄限制拦截）**
   ...
   * *对策*：访问 Google 账号年龄验证专线 [https://myaccount.google.com/age-verification?utm_source=p0](https://myaccount.google.com/age-verification?utm_source=p0)，完成实名/信用卡年龄验证。完成后等待 5 分钟，在 Cockpit 刷新状态，变为 `free/pro/ultra` 后重新注入登录。
2. **多开工具引发的数据串联**
